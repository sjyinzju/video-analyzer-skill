...
【输出与排版要求】
请在 `E:\知识管理\视频总结` 文件夹下，新建一个名为“YYYYMMDD-视频核心主题”的**文件夹**。在该文件夹内，生成同名 Markdown 笔记，并严格遵守以下结构：

1. Frontmatter (YAML属性区)
   - title: [精简标题]
   - date: [当前日期]
   - tags: [自动匹配2-3个标签：#AI工具 #历史研究 #量化投资 #人生思维 #读书 #课程学习 #马克思主义理论 #局势分析 等]
   - source: [原视频链接]
...
5. 跨域关联
   评估内容与“课程、人工智能应用、量化与数据分析、人生思维、创新、人文历史、内容传播与自媒体”或已有笔记的潜在交叉点。提炼跨学科新视角，关键概念使用 `[[ ]]` 生成双向链接。
